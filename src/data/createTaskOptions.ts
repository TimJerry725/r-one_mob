...
export const DATA_TYPES = ['Short text', 'Long text', 'Number', 'Date', 'Media', 'Multiple Choice', 'Radio button', 'Checkbox', 'Dropdown', 'None', '3 phase voltage', 'Email', 'Section Header', 'Checklist Header'] as const;
